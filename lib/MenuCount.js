        ...
        menuData = [
            {
                ...
                "text": "接口审批",
                "iconCls": "icon-blank",
                "attributes": { "Path": "pagelist/HSE_aprove.html"},
                "children": [
                    {
                        "id": 101,
                        "text": "接口审批",
            ...
            },
            {
                ...
                "text": "接口配置",
                "iconCls": "icon-blank",
                "attributes": { "Path": "pagelist/Interface_configuration.html"},
                "children": [
                    {
                        "id": 102,
                        "text": "接口配置",
            ...
            },
            {
                ...
                "text": "接口查询",
                "iconCls": "icon-blank",
                "attributes": { "Path": "pagelist/HES_Interfacequery.html"},
                "children": [
                    {
                        "id": 103,
                        "text": "接口查询",
            ...
            },
            {
                ...
                "children": [
                    {
                        id: 4000, "parentId": 4, "text": "日志", "iconCls": "icon-blank","state": "closed", "attributes": {"Path":"pagelist/Journal.html" }
                    },
                    {
                        "id": 4001, "parentId": 4, "text": "配置文件备份", "iconCls": "icon-blank","state": "closed",  "attributes": {"Path":"pagelist/ConfigFileback.html" }
                    },
                    {
                        "id": 4002, "parentId": 4, "text": "用户管理", "iconCls": "icon-blank","state": "closed",  "attributes": {"Path":"pagelist/User_manage.html" }
                    },
                ]
            }
        ]
        ...
        menuData = [
            {
                ...
                "text": "接口申请",
                "iconCls": "icon-blank",
                "attributes": { "Path": "pagelist/Interface_page.html"},
                "children": [
                    {
                        "id": 101,
                        "text": "接口申请",
            ...
            },
            {
                ...
                "text": "权限对照",
                "iconCls": "icon-blank",
                "attributes": { "Path": "pagelist/Interface_Contrast.html"},
                "children": [
                    {
                        "id": 102,
                        "text": "权限对照",
